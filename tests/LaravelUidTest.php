...
use Tests\TestCase;
use Alecgarcia\LaravelUid\LaravelUid;
...
class LaravelUidTest extends TestCase
{
    ...
    {
        $uid = LaravelUid::make('prefix', 10);
        $this->assertEquals(10, strlen($uid));

        $uid = LaravelUid::make('prefix', 24);
